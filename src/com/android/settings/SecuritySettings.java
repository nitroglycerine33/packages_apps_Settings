...
public class SecuritySettings extends SettingsPreferenceFragment
    ...
    private PreferenceScreen createPreferenceHierarchy() {
        ...
        if (mLockAfter != null) {
            ...
            addPreferencesFromResource(R.xml.security_settings_slide_delay_eclipse);
        ...
        if (isCmSecurity) {
            ...
            // Add the additional eclipse settings
            addPreferencesFromResource(R.xml.security_settings_eclipse);
        ...
        if (!isCmSecurity) {
            ...
            if (isTelephony) {
                addPreferencesFromResource(R.xml.security_settings_app_eclipse);
